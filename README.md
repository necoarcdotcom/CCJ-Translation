...
The game dumps untranslated strings into `BepInEx/Translation/en/Text/_AutoGeneratedTranslations.txt` while it runs. To contribute translations from that file:
